...
extension PhotosListViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, willDisplay cell: UITableViewCell, forRowAt indexPath: IndexPath) {
        //если не обновлено и индекс паф равен последней ячейке то отправляем
...
//MARK: - SEND REQUESTS
//Запросы разделили на несколько отдельных
extension PhotosListViewController {
    ...
    fileprivate func getSizesRequest() {
        ...
        PhotoCreaterManager.getSizeFor(photosArray: arrayOfPhotosForRequest) { [weak self] in
            ...
            //как только получили массив фотко добавляем их в таблицу и обновляем таблицу
